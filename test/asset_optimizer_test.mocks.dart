...
// in shotly/test/asset_optimizer_test.dart.
...
import 'package:shotly/src/utils/asset_optimizer.dart' as _i3;
...
class MockImageCompressor extends _i1.Mock implements _i3.ImageCompressor {
  MockImageCompressor() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i4.Future<_i5.Uint8List> compressWithList(
    _i5.Uint8List? list, {
    int? minWidth = 1,
    int? minHeight = 1,
    int? quality = 95,
    int? rotate = 0,
    int? inSampleSize = 1,
    _i6.CompressFormat? format = _i6.CompressFormat.jpeg,
    bool? keepExif = false,
  ...
  @override
  _i4.Future<_i2.File?> compressAndGetFile(
    String? srcPath,
    String? destPath, {
    int? minWidth = 1,
    int? minHeight = 1,
