...
// in shotly/test/firestore_optimizer_test.dart.
...
/// A class which mocks [LoadBundleTask].
///
/// See the documentation for Mockito's code generation for more information.
class MockLoadBundleTask extends _i1.Mock implements _i4.LoadBundleTask {
  MockLoadBundleTask() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i5.Stream<_i4.LoadBundleTaskSnapshot> get stream => (super.noSuchMethod(
        Invocation.getter(#stream),
        returnValue: _i5.Stream<_i4.LoadBundleTaskSnapshot>.empty(),
      ) as _i5.Stream<_i4.LoadBundleTaskSnapshot>);
}

/// A class which mocks [LoadBundleTaskSnapshot].
///
/// See the documentation for Mockito's code generation for more information.
class MockLoadBundleTaskSnapshot extends _i1.Mock
    implements _i4.LoadBundleTaskSnapshot {
  MockLoadBundleTaskSnapshot() {
    _i1.throwOnMissingStub(this);
  }

  @override
  int get bytesLoaded => (super.noSuchMethod(
        Invocation.getter(#bytesLoaded),
        returnValue: 0,
      ) as int);

  @override
  int get documentsLoaded => (super.noSuchMethod(
        Invocation.getter(#documentsLoaded),
        returnValue: 0,
      ) as int);

  @override
  _i3.LoadBundleTaskState get taskState => (super.noSuchMethod(
        Invocation.getter(#taskState),
        returnValue: _i3.LoadBundleTaskState.running,
      ) as _i3.LoadBundleTaskState);
  ...
  @override
  int get totalDocuments => (super.noSuchMethod(
        Invocation.getter(#totalDocuments),
        returnValue: 0,
      ) as int);
}
