...
# Simple Certificate Pinning Test
# This script directly tests that the certificate validation failure is properly logged
...
if grep -F "SSL Pinning validation failed" "$LOG_FILE"; then
